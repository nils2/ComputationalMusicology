...
### *NEW * **Data analitics** {data-commentary-width=800}
...
p13 <- ggplot() +
  ...
  geom_rect(aes(xmin = 6.2, xmax = 15, ymin = 12.2, ymax = 15), 
            fill = "#00204DFF") +
  annotate(geom = "text", y= 10, x = 2.4, label = "30", color = "white", fontface = 2, hjust= 0) +
  annotate(geom = "text", y= 2.3, x = 2.4, label = "14", color = "white", fontface = 2, hjust= 0) +
  annotate(geom = "text", y= 13.5, x = 9.8, label = "12", color = "white", fontface = 2, hjust= 0) +
  annotate(geom = "text", y= 6, x = 9.8, label = "59", color = "black", fontface = 2, hjust= 0) +
...
### **Comparing with typical tracks** {data-commentary-width=800}
...
### **What's the Key?** {data-commentary-width=800}
...
### **Too loud and slow** {data-commentary-width=800}
